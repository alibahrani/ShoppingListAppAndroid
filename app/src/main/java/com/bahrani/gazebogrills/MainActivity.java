...
public class MainActivity extends AppCompatActivity implements ListFragment.onProductSelectedInterface {
    ...
    @Override
    public void onListProductSelected(int index) {

        ViewPagerFragment fragment = new ViewPagerFragment();
        Bundle bundle = new Bundle();
        bundle.putInt(ViewPagerFragment.KEY_PRODUCT_INDEX, index);
